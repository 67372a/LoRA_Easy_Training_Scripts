...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.max_train_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Formerly named: Keep Tokens Separator</p><p>Keep Tags Seperator is an alternative way to Keep Tokens/Tags to allow for dynamic keep tags per file versus per folder by using a separator string such as ||| which is all but guaranteed to show up in any caption.</p><p>Protected Tags File is suggested as a better alternative.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_label.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Number of PyTorch DataLoader worker processes used to prepare batches in parallel, increases CPU/RAM use (decoding/preprocessing/etc) so GPUs stay busy</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_label.setText(QCoreApplication.translate("base_args_ui", u"Max Data Loader Workers", None))
#if QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Number of PyTorch DataLoader worker processes used to prepare batches in parallel, increases CPU/RAM use (decoding/preprocessing/etc) so GPUs stay busy</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.no_half_vae_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>This loads the VAE in FP32 or full precision. Roughly doubles VRAM usage, but is sometimes required on older graphics cards</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
