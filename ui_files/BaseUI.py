...
class Ui_base_args_ui(object):
    def setupUi(self, base_args_ui):
        ...
        self.formLayout_5.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_2)
        ...
        self.formLayout_5.setWidget(1, QFormLayout.ItemRole.FieldRole, self.max_token_selector)
        ...
        self.formLayout_5.setWidget(2, QFormLayout.ItemRole.FieldRole, self.mixed_precision_selector)

        self.label_6 = QLabel(base_args_ui)
        self.label_6.setObjectName(u"label_6")

        self.formLayout_5.setWidget(3, QFormLayout.ItemRole.LabelRole, self.label_6)
        ...
        self.formLayout_5.setLayout(3, QFormLayout.ItemRole.FieldRole, self.horizontalLayout_3)
        ...
        self.formLayout_5.setWidget(4, QFormLayout.ItemRole.LabelRole, self.keep_tokens_seperator_enable)
        ...
        self.formLayout_5.setWidget(4, QFormLayout.ItemRole.FieldRole, self.keep_tokens_seperator_input)
        ...
        self.formLayout_5.setWidget(5, QFormLayout.ItemRole.LabelRole, self.global_protected_tags_file_enable)
        ...
        self.formLayout_5.setLayout(5, QFormLayout.ItemRole.FieldRole, self.global_protected_tags_file_hLayout)
        ...
        self.formLayout_6.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_9)
        ...
        self.formLayout_6.setWidget(1, QFormLayout.ItemRole.FieldRole, self.clip_skip_input)

        self.label_10 = QLabel(base_args_ui)
        self.label_10.setObjectName(u"label_10")

        self.formLayout_6.setWidget(2, QFormLayout.ItemRole.LabelRole, self.label_10)
        ...
        self.formLayout_6.setWidget(2, QFormLayout.ItemRole.FieldRole, self.loss_weight_input)
        ...
        self.formLayout_6.setWidget(3, QFormLayout.ItemRole.LabelRole, self.max_data_loader_n_workers_label)
        ...
        self.formLayout_6.setWidget(3, QFormLayout.ItemRole.FieldRole, self.max_data_loader_n_workers_input)
        ...
        self.formLayout_6.setLayout(4, QFormLayout.ItemRole.SpanningRole, self.horizontalLayout_7)
        ...
        self.formLayout_6.setLayout(5, QFormLayout.ItemRole.SpanningRole, self.horizontalLayout_5)
        ...
        sizePolicy.setHeightForWidth(self.resolution_box.sizePolicy().hasHeightForWidth())
        self.resolution_box.setSizePolicy(sizePolicy)
        self.resolution_box.setSizeIncrement(QSize(0, 0))
        self.resolution_box.setBaseSize(QSize(0, 0))
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.keep_tokens_seperator_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Formerly named: Keep Tokens Separator</p><p>Keep Tags Seperator is an alternative way to Keep Tokens/Tags to allow for dynamic keep tags per file versus per folder by using a separator string such as ||| which is all but guaranteed to show up in any caption.</p><p>Protected Tags File is suggested as a better alternative</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.keep_tokens_seperator_enable.setText(QCoreApplication.translate("base_args_ui", u"Keep Tags Seperator", None))
#if QT_CONFIG(tooltip)
        self.keep_tokens_seperator_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Formerly named: Keep Tokens Separator</p><p>Keep Tags Seperator is an alternative way to Keep Tokens/Tags to allow for dynamic keep tags per file versus per folder by using a separator string such as ||| which is all but guaranteed to show up in any caption.</p><p>Protected Tags File is suggested as a better alternative</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.global_protected_tags_file_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>A '.txt' file containing tags to protect from caption tag dropout (one tag per line). Similar to 'Keep Tags/Tokens' except that protected tags work with shuffle captions to allow less stiff prompting.</p><p>This setting applies to every subset but can be overwritten on a per-subset basis by the Protected Tags File setting in the subset Optional Args section</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.global_protected_tags_file_enable.setText(QCoreApplication.translate("base_args_ui", u"Protected Tags File (Global)", None))
#if QT_CONFIG(tooltip)
        self.global_protected_tags_file_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>A '.txt' file containing tags to protect from caption tag dropout (one tag per line). Similar to 'Keep Tags/Tokens' except that protected tags work with shuffle captions to allow less stiff prompting.</p><p>This setting applies to every subset but can be overwritten on a per-subset basis by the Protected Tags File setting in the subset Optional Args section</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.global_protected_tags_file_selector.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>A '.txt' file containing tags to protect from caption tag dropout (one tag per line). Similar to 'Keep Tags/Tokens' except that protected tags work with shuffle captions to allow less stiff prompting.</p><p>This setting applies to every subset but can be overwritten on a per-subset basis by the Protected Tags File setting in the subset Optional Args section</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.comment_input.setPlaceholderText(QCoreApplication.translate("base_args_ui", u"Enter a comment you want in the metadata", None))
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_label.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Number of PyTorch DataLoader worker processes used to prepare batches in parallel, increases CPU/RAM use (decoding/preprocessing/etc) so GPUs stay busy. <br/>Persistent DataLoader workers is enabled by default.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_label.setText(QCoreApplication.translate("base_args_ui", u"Max Data Loader Workers", None))
#if QT_CONFIG(tooltip)
        self.max_data_loader_n_workers_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Number of PyTorch DataLoader worker processes used to prepare batches in parallel, increases CPU/RAM use (decoding/preprocessing/etc) so GPUs stay busy. <br/>Persistent DataLoader workers is enabled by default.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.base_model_input.setProperty(u"placeholderText", QCoreApplication.translate("base_args_ui", u"Base model to train with", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.vae_input.setProperty(u"placeholderText", QCoreApplication.translate("base_args_ui", u"VAE to train with", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.FP16_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Allows training on full FP16. Not compatible with full BF16 or training precision</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.BF16_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Train in full BF16. Not compatible with full FP16 or training precision</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
