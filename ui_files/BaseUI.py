...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.global_protected_tags_file_selector.setToolTip(QCoreApplication.translate("base_args_ui", u"TDOO | is overwritten by subset specific protected tags file", None))
#endif // QT_CONFIG(tooltip)
