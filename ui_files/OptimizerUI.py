...
class Ui_optimizer_ui(object):
    def setupUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"RelAdamW", None))
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"SimplifiedAdEMAMixAINO", None))
