...
class Ui_optimizer_ui(object):
    def setupUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.addItem(QCoreApplication.translate("optimizer_ui", u"FishMonger8BitBNB", None))
    ...
    def retranslateUi(self, optimizer_ui):
        ...
        self.loss_type_selector.setItemText(5, QCoreApplication.translate("optimizer_ui", u"Log Cosh", None))
#if QT_CONFIG(tooltip)
