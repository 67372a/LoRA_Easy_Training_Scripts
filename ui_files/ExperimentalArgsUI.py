...
#if QT_CONFIG(tooltip)
        self.flow_timestep_distribution_selector.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>How timesteps are sampled for Rectified Flow<br/>&quot;uniform&quot; = all timesteps equally likely<br/>&quot;logit_normal&quot; = biased sampling via a logit-normal, tunable via logit mean/std</p><p><span style=\" font-family:'JetBrainsMono Nerd Font';\">--flow_timestep_distribution</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.label_8.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Forces a fixed shift/ratio for timestep adjustment, instead of using image size like <span style=\" font-family:'JetBrainsMono Nerd Font';\">--flow_uniform_shift</span></p><p>Higher: focus on less noisy, low-frequency, later timesteps<br/>Lower: focus on noisier, high-frequency, earlier timesteps<br/>For 1024px training, a value of around 2-3 may be fine</p><p><span style=\" font-family:'JetBrainsMono Nerd Font';\">--flow_uniform_static_ratio</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_8.setText(QCoreApplication.translate("base_args_ui", u"Uniform Static Shift", None))
#if QT_CONFIG(tooltip)
        self.flow_uniform_static_ratio_shift_input.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Forces a fixed shift/ratio for timestep adjustment, instead of using image size like <span style=\" font-family:'JetBrainsMono Nerd Font';\">--flow_uniform_shift</span></p><p>Higher: focus on less noisy, low-frequency, later timesteps<br/>Lower: focus on noisier, high-frequency, earlier timesteps<br/>For 1024px training, a value of around 2-3 may be fine</p><p><span style=\" font-family:'JetBrainsMono Nerd Font';\">--flow_uniform_static_ratio</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.cfm_enable.setToolTip(QCoreApplication.translate("base_args_ui", u"<html><head/><body><p>Enable Contrastive Flow Matching (\u0394FM) objective. Works with v-parameterization/v-pred (untested) or Rectified Flow.<br/>Adds a loss that helps the model tell apart correct and incorrect noise pairs</p><p><span style=\" font-family:'JetBrainsMono Nerd Font';\">--contrastive_flow_matching</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
