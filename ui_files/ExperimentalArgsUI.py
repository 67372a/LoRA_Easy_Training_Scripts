...
class Ui_base_args_ui(object):
    def setupUi(self, base_args_ui):
        if not base_args_ui.objectName():
            base_args_ui.setObjectName("base_args_ui")
        ...
        self.misc_experimental_args_tab_notice.setObjectName("misc_experimental_args_tab_notice")
        ...
        self.experimental_args_notice_label.setObjectName("experimental_args_notice_label")
        ...
        self.flow_model_settings_box.setObjectName("flow_model_settings_box")
        ...
        self.flow_notice_label.setObjectName("flow_notice_label")
        ...
        self.flow_logit_mean_input.setObjectName("flow_logit_mean_input")
        ...
        self.flow_logit_std_input.setObjectName("flow_logit_std_input")
        ...
        self.flow_timestep_distribution_selector.addItem("")
        self.flow_timestep_distribution_selector.setObjectName("flow_timestep_distribution_selector")
        ...
        self.flow_uniform_static_ratio_shift_input.setObjectName("flow_uniform_static_ratio_shift_input")
        ...
        self.flow_optimal_transport_enable.setObjectName("flow_optimal_transport_enable")
        ...
        self.advanced_vae_settings_box.setObjectName("advanced_vae_settings_box")
        ...
        self.advanced_vae_settings_formLayout.setObjectName("advanced_vae_settings_formLayout")
        self.formLayout_5 = QFormLayout()
        self.formLayout_5.setObjectName("formLayout_5")
        self.formLayout_5.setContentsMargins(-1, -1, 3, -1)
        self.vae_batch_size_label = QLabel(self.advanced_vae_settings_box)
        self.vae_batch_size_label.setObjectName("vae_batch_size_label")
        ...
        self.vae_batch_size_input.setObjectName("vae_batch_size_input")
        ...
        self.vae_reflection_enable.setObjectName("vae_reflection_enable")
        ...
        self.vae_custom_scale_enable.setObjectName("vae_custom_scale_enable")
        ...
        self.vae_custom_scale_input.setObjectName("vae_custom_scale_input")
        ...
        self.vae_custom_shift_enable.setObjectName("vae_custom_shift_enable")
        ...
        self.vae_custom_shift_input.setObjectName("vae_custom_shift_input")
        ...
        self.zero_cond_dropout_enable.setObjectName("zero_cond_dropout_enable")
        ...
        self.debiased_estimation_loss_enable.setObjectName("debiased_estimation_loss_enable")
        ...
        self.cfm_enable.setObjectName("cfm_enable")
        ...
        self.cfm_lambda_enable.setObjectName("cfm_lambda_enable")
        ...
        self.cfm_lambda_input.setObjectName("cfm_lambda_input")
    ...
    def retranslateUi(self, base_args_ui):
        base_args_ui.setWindowTitle(QCoreApplication.translate("base_args_ui", "Form", None))
        self.experimental_args_notice_label.setText(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>This section contains some less commonly used and/or advanced/experimental settings.<br/>Usually there is no need to enable these unless you know what you are doing.<br/>Do not rely on the defaults.</p></body></html>",
                None,
            )
        )
        self.flow_model_settings_box.setTitle(QCoreApplication.translate("base_args_ui", "Flow Model", None))
        self.flow_notice_label.setText(
            QCoreApplication.translate(
                "base_args_ui",
                '<html><head/><body><p>Experimental Rectified Flow settings, incompatible with V Param; Enables <code>--flow_model</code><br/>Made with SDXL-based NoobAI-RF models by <a href="https://huggingface.co/CabalResearch"><span style=" text-decoration: underline; color:#00d9cb;">CabalResearch</code></a> in mind.<br/>(For Flux.1 training please visit the corresponding section)</p></body></html>',
                None,
            )
        )
        ...
        self.label.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Shifts which timesteps are focused on when using &quot;logit_normal&quot; (higher = later steps, lower = earlier steps)</p><p><code>--flow_logit_mean</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("base_args_ui", "Logit Mean", None))
        # if QT_CONFIG(tooltip)
        self.flow_logit_mean_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Shifts which timesteps are focused on when using &quot;logit_normal&quot; (higher = later steps, lower = earlier steps)</p><p><code>--flow_logit_mean</code></p></body></html>",
                None,
        ...
        self.label_2.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Controls how spread out the focus is for &quot;logit_normal&quot; (higher = more spread, lower = more focused)</p><p><code>--flow_logit_std</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_2.setText(QCoreApplication.translate("base_args_ui", "Logit std", None))
        # if QT_CONFIG(tooltip)
        self.flow_logit_std_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Controls how spread out the focus is for &quot;logit_normal&quot; (higher = more spread, lower = more focused)</p><p><code>--flow_logit_std</code></p></body></html>",
                None,
        ...
        self.label_4.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>How timesteps are sampled for Rectified Flow<br/>&quot;uniform&quot; = all timesteps equally likely<br/>&quot;logit_normal&quot; = biased sampling via a logit-normal</p><p><code>--flow_timestep_distribution</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_4.setText(QCoreApplication.translate("base_args_ui", "Timestep Distribution", None))
        self.flow_timestep_distribution_selector.setItemText(
            0, QCoreApplication.translate("base_args_ui", "logit_normal", None)
        )
        self.flow_timestep_distribution_selector.setItemText(
            1, QCoreApplication.translate("base_args_ui", "uniform", None)
        )

        # if QT_CONFIG(tooltip)
        self.flow_timestep_distribution_selector.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>How timesteps are sampled for Rectified Flow<br/>&quot;uniform&quot; = all timesteps equally likely<br/>&quot;logit_normal&quot; = biased sampling via a logit-normal, tunable via logit mean/std</p><p><code>--flow_timestep_distribution</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.label_8.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Forces a fixed shift/ratio for timestep adjustment, instead of using image size like <code>--flow_uniform_shift</code></p><p>Higher: focus on less noisy, low-frequency, later timesteps<br/>Lower: focus on noisier, high-frequency, earlier timesteps<br/>For 1024px training, a value of around 2-3 may be fine</p><p><code>--flow_uniform_static_ratio</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_8.setText(QCoreApplication.translate("base_args_ui", "Uniform Static Shift", None))
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.flow_optimal_transport_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>When Flow Model/Rectified Flow is enabled, pair latents and noises within a batch using cosine optimal transport (OT) instead of fixed pairing. Improves matching between samples for flow objectives/\u0394FM (Contrastive Flow Matching)</p><p>Recommended to be enabled</p><p><code>--flow_use_ot</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.flow_optimal_transport_enable.setText(
            QCoreApplication.translate("base_args_ui", "Optimal Transport", None)
        )
        self.advanced_vae_settings_box.setTitle(
            QCoreApplication.translate("base_args_ui", "Advanced VAE settings", None)
        )
        # if QT_CONFIG(tooltip)
        self.vae_batch_size_label.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Number of images processed at once when encoding latents. Increase for faster encoding if you have enough VRAM</p><p><code>--vae_batch_size</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.vae_batch_size_label.setText(QCoreApplication.translate("base_args_ui", "VAE Batch Size", None))
        # if QT_CONFIG(tooltip)
        self.vae_batch_size_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Number of images processed at once when encoding latents. Increase for faster encoding if you have enough VRAM</p><p><code>--vae_batch_size</code></p></body></html>",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.vae_reflection_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Only applicable to models and VAEs that were trained together with reflect padding.</p><p>Uses reflect padding to mirror image edges in the conv layers of the VAE which helps avoiding edge artifacts.<br/>If you don't know what this is, you can likely ignore it</p><p><code>--vae_reflection_padding</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.vae_reflection_enable.setText(QCoreApplication.translate("base_args_ui", "VAE Reflection", None))
        # if QT_CONFIG(tooltip)
        self.vae_custom_scale_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Change the scaling factor applied to latents after VAE encoding. Leave empty to use the default (E.g.: 0.18215 for SDXL VAE)</p><p><code>--vae_custom_scale</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.vae_custom_scale_enable.setText(QCoreApplication.translate("base_args_ui", "VAE Custom Scale", None))
        # if QT_CONFIG(tooltip)
        self.vae_custom_scale_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Change the scaling factor applied to latents after VAE encoding. Leave empty to use the default (E.g.: 0.18215 for SDXL VAE)</p><p><code>--vae_custom_scale</code></p></body></html>",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.vae_custom_shift_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Add a constant offset to latents before scaling</p><p><code>--vae_custom_shift</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.vae_custom_shift_enable.setText(QCoreApplication.translate("base_args_ui", "VAE Custom Shift", None))
        # if QT_CONFIG(tooltip)
        self.vae_custom_shift_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Add a constant offset to latents before scaling</p><p><code>--vae_custom_shift</code></p></body></html>",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.zero_cond_dropout_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>For full caption dropout, use zeroed conditioning instead of an empty caption/empty string.<br/>Useful for training the model to handle unconditional generation.<br/>Not recommended to be enabled on models that were not already trained with this (can be tested by using zeroed negative conditioning and checking if the output looks how it's supposed to compared to empty string or similar; Models trained without this may look off and doesn't adhere to style)</p><p><code>--use_zero_cond_dropout</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.zero_cond_dropout_enable.setText(
            QCoreApplication.translate("base_args_ui", "Zero Conditioning Dropout", None)
        )
        # if QT_CONFIG(tooltip)
        self.debiased_estimation_loss_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Calculates loss using Debiased Estimation. Similar purpose to Min-SNR but a different approach. <br/>Incompatible with Flow Model/Rectified Flow</p><p><code>--debiased_estimation_loss</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.debiased_estimation_loss_enable.setText(
            QCoreApplication.translate("base_args_ui", "Debiased Estimation Loss", None)
        )
        # if QT_CONFIG(tooltip)
        self.cfm_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Enable Contrastive Flow Matching (\u0394FM) objective. Works with v-parameterization/v-pred (untested) or Rectified Flow.<br/>Adds a loss that helps the model tell apart correct and incorrect noise pairs</p><p><code>--contrastive_flow_matching</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.cfm_enable.setText(QCoreApplication.translate("base_args_ui", "Contrastive Flow Matching", None))
        # if QT_CONFIG(tooltip)
        self.cfm_lambda_enable.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Scalar weight applied to the contrastive term in \u0394FM loss. Higher = stronger effect</p><p><code>--cfm_lambda</code></p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.cfm_lambda_enable.setText(
            QCoreApplication.translate("base_args_ui", "Contrastive Flow Matching Lamdba", None)
        )
        # if QT_CONFIG(tooltip)
        self.cfm_lambda_input.setToolTip(
            QCoreApplication.translate(
                "base_args_ui",
                "<html><head/><body><p>Scalar weight applied to the contrastive term in \u0394FM loss. Higher = stronger effect</p><p><code>--cfm_lambda</code></p></body></html>",
                None,
