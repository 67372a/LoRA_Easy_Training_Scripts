...
class Ui_sub_dataset_extra_input(object):
    def setupUi(self, sub_dataset_extra_input):
        ...
        self.gamma_aug_group = QGroupBox(sub_dataset_extra_input)
        self.gamma_aug_group.setObjectName(u"gamma_aug_group")
        self.gamma_aug_group.setEnabled(True)
        self.gamma_aug_group.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.gamma_aug_group.setCheckable(True)
        self.gamma_aug_group.setChecked(False)
        self.formLayout_gamma = QFormLayout(self.gamma_aug_group)
        self.formLayout_gamma.setObjectName(u"formLayout_gamma")
        self.formLayout_gamma.setContentsMargins(9, 9, 9, 9)

        self.gamma_aug_min_label = QLabel(self.gamma_aug_group)
        self.gamma_aug_min_label.setObjectName(u"gamma_aug_min_label")
        self.formLayout_gamma.setWidget(0, QFormLayout.ItemRole.LabelRole, self.gamma_aug_min_label)

        self.gamma_aug_min_input = DoubleSpinBox(self.gamma_aug_group)
        self.gamma_aug_min_input.setObjectName(u"gamma_aug_min_input")
        self.gamma_aug_min_input.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        self.gamma_aug_min_input.setDecimals(2)
        self.gamma_aug_min_input.setMinimum(0.010000000000000)
        self.gamma_aug_min_input.setMaximum(1.000000000000000)
        self.gamma_aug_min_input.setSingleStep(0.010000000000000)
        self.gamma_aug_min_input.setValue(0.950000000000000)
        self.formLayout_gamma.setWidget(0, QFormLayout.ItemRole.FieldRole, self.gamma_aug_min_input)

        self.gamma_aug_max_label = QLabel(self.gamma_aug_group)
        self.gamma_aug_max_label.setObjectName(u"gamma_aug_max_label")
        self.formLayout_gamma.setWidget(1, QFormLayout.ItemRole.LabelRole, self.gamma_aug_max_label)

        self.gamma_aug_max_input = DoubleSpinBox(self.gamma_aug_group)
        self.gamma_aug_max_input.setObjectName(u"gamma_aug_max_input")
        self.gamma_aug_max_input.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        self.gamma_aug_max_input.setDecimals(2)
        self.gamma_aug_max_input.setMinimum(1.000000000000000)
        self.gamma_aug_max_input.setMaximum(10.000000000000000)
        self.gamma_aug_max_input.setSingleStep(0.010000000000000)
        self.gamma_aug_max_input.setValue(1.050000000000000)
        self.formLayout_gamma.setWidget(1, QFormLayout.ItemRole.FieldRole, self.gamma_aug_max_input)

        self.gamma_aug_rate_label = QLabel(self.gamma_aug_group)
        self.gamma_aug_rate_label.setObjectName(u"gamma_aug_rate_label")
        self.formLayout_gamma.setWidget(2, QFormLayout.ItemRole.LabelRole, self.gamma_aug_rate_label)

        self.gamma_aug_rate_input = DoubleSpinBox(self.gamma_aug_group)
        self.gamma_aug_rate_input.setObjectName(u"gamma_aug_rate_input")
        self.gamma_aug_rate_input.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
        self.gamma_aug_rate_input.setDecimals(2)
        self.gamma_aug_rate_input.setMinimum(0.000000000000000)
        self.gamma_aug_rate_input.setMaximum(1.000000000000000)
        self.gamma_aug_rate_input.setSingleStep(0.050000000000000)
        self.gamma_aug_rate_input.setValue(0.500000000000000)
        self.formLayout_gamma.setWidget(2, QFormLayout.ItemRole.FieldRole, self.gamma_aug_rate_input)

        self.verticalLayout.addWidget(self.gamma_aug_group)
...
#if QT_CONFIG(tooltip)
        self.gamma_aug_group.setToolTip(QCoreApplication.translate("sub_dataset_extra_input", u"<html><head/><body><p>Gamma Augmentation randomly adjusts the mid-tone brightness of images each step using a power curve. Unlike brightness shifting, it preserves detail in highlights and shadows. Applied per-image at the specified probability.</p><p>Min/Max Gamma: Values &lt;1 brighten, values &gt;1 darken mid-tones. A tight range like 0.95-1.05 is recommended.</p><p>Rate: Probability (0.0-1.0) that augmentation is applied to any given image.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.gamma_aug_group.setTitle(QCoreApplication.translate("sub_dataset_extra_input", u"Gamma Augmentation", None))
        self.gamma_aug_min_label.setText(QCoreApplication.translate("sub_dataset_extra_input", u"min gamma", None))
        self.gamma_aug_max_label.setText(QCoreApplication.translate("sub_dataset_extra_input", u"max gamma", None))
        self.gamma_aug_rate_label.setText(QCoreApplication.translate("sub_dataset_extra_input", u"rate", None))
#if QT_CONFIG(tooltip)
        self.gamma_aug_min_input.setToolTip(QCoreApplication.translate("sub_dataset_extra_input", u"<html><head/><body><p>Minimum gamma value. Values &lt;1.0 brighten mid-tones. Recommended: 0.90-0.97.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.gamma_aug_max_input.setToolTip(QCoreApplication.translate("sub_dataset_extra_input", u"<html><head/><body><p>Maximum gamma value. Values &gt;1.0 darken mid-tones. Recommended: 1.03-1.10.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.gamma_aug_rate_input.setToolTip(QCoreApplication.translate("sub_dataset_extra_input", u"<html><head/><body><p>The probability (0.0 to 1.0) that gamma augmentation will be applied to any single image during training. 0.5 = 50% of images will be augmented.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
    # retranslateUi
